    ...
    CustomUserPreferences = {
      "com.apple.symbolichotkeys" = {
        AppleSymbolicHotKeys = {
          ...
          # Disable macOS screenshot shortcuts so Shottr can own ⌘⇧3 / ⌘⇧4.
      ...
      # Shottr capture hotkeys. Values are the KeyboardShortcuts library's
      # carbon encoding: carbonModifiers 768 = ⌘⇧, 6400 = ⌃⌥⌘. Carbon key
      # codes: 19=2, 20=3, 21=4, 31=O.
      "cc.ffitch.shottr" = {
